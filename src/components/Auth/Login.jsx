...
const Login = ({handleLogin}) => {
  ...
  const fillEmployeeCredentials = (email, password) => {
    setFormData({
      email,
      password
    });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-900 via-indigo-900 to-blue-900 relative overflow-hidden">
      ...
      {showNote && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <div className="bg-gradient-to-br from-violet-900/90 to-indigo-900/90 p-8 rounded-3xl border border-white/20 shadow-2xl max-w-2xl w-[90%] max-h-[80vh] relative transform transition-all duration-300 scale-100 animate-fadeIn">
            ...
            <div className="space-y-4 overflow-y-auto max-h-[50vh] pr-4 custom-scrollbar">
              <div onClick={fillAdminCredentials} className="bg-white/5 p-4 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors duration-300 cursor-pointer">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60">Email: <span className="text-purple-300">harshchovatiya16@gmail.com</span></p>
                    <p className="text-white/60">Password: <span className="text-purple-300">Harsh@123</span></p>
                  </div>
                </div>
              </div>

              {getLocalStorage().employees.map((employee, index) => (
                <div key={index} onClick={() => fillEmployeeCredentials(employee.email, employee.password)} className="bg-white/5 p-4 rounded-2xl border border-white/10 hover:bg-white/10 transition-colors duration-300 cursor-pointer">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-white font-medium mb-1">Employee Access - {employee.name}</h4>
                      <p className="text-white/60">Email: <span className="text-purple-300">{employee.email}</span></p>
                      <p className="text-white/60">Password: <span className="text-purple-300">{employee.password}</span></p>
                    </div>
                  </div>
                </div>
              ))}
